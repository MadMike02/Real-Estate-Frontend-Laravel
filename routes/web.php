...
//Route::get('/st=ab',[HomeController::class, 'front'])->name('view_home');
...
Route::get('/property/BankMorgage',[HomeController::class, 'bank_properties'])->name('bank_prop');
...
Route::get('/Agents',[HomeController::class, 'agents_list'])->name('view_agents');
