												...
												<div class="submit-section">
													<div class="form-row">
														...
														<div class="form-group col-md-6">
															...
															<input type="number" min=0 class="form-control" placeholder="Price in INR" name="price" required>
														</div>
														...
														<div class="form-group col-md-12">
															...
															<div class="row">
																...
																<div clas="col-4">
																	...
																	<input type="file" name="floor_file[]" accept=".jpeg, .jpg" <?php if($_COOKIE["role"] != "customer"){echo "required";} ?>>
																</div>
																...
																<div class="col-4 mt-2">
																	<input id=<?php echo "'config_".$i."'" ?> type="text" class="form-control" placeholder="BHKs" name="Config[]">
																</div>
																<div class="col-4 mt-2">
																	<input id=<?php echo "'dimen_".$i."'" ?> type="text" class="form-control" placeholder="Sq.Ft" name="dimensions[]">
																</div>
																<div clas="col-4 mt-2">
																	<input id=<?php echo "'dimen_pic_".$i."'" ?> type="file" accept=".jpeg, .jpg" name="floor_file[]">
																</div>
																<div class="col-12 w-100 mt-2 mb-2"></div>
																@endfor
																<?php
											...
											<div class="form-submit">
												...
												<div class="submit-section">
													<div class="form-row">
														...
														<button id="search_add" type="button" class="btn btn-info ml-3">SEARCH ADDRESS</button>
														<br>
											...
											<div class="form-group col-md-12 mt-3">
															...
															<div class="o-features">
																<ul class="no-ul-list third-row">
																	...
																	<li>
																		<input id="a-16" class="checkbox-custom nearby" type="checkbox" value="Departmental Stores" name="nearby[]">
																		<label for="a-16" class="checkbox-custom-label">Departmental Stores</label>
																	</li>
																	<li>
																		<input id="a-17" class="checkbox-custom nearby" type="checkbox" value="School" name="nearby[]">
																		<label for="a-17" class="checkbox-custom-label">School</label>
																	</li>
																	<li>
																		<input id="a-18" class="checkbox-custom nearby" type="checkbox" value="Stationary & Book Store" name="nearby[]">
																		<label for="a-18" class="checkbox-custom-label">Stationary & Book Store</label>
																	</li>
																	<li>
																		<input id="a-19" class="checkbox-custom nearby" type="checkbox" value="Medical Store" name="nearby[]">
																		<label for="a-19" class="checkbox-custom-label">Medical Store</label>
																	</li>
																	<li>
																		<input id="a-20" class="checkbox-custom nearby" type="checkbox" value="Food & Vegetable Store" name="nearby[]">
																		<label for="a-20" class="checkbox-custom-label">Food & Vegetable Store</label>
																	</li>
																</ul>
																<!-- OTHERS :
													...
													<div class="form-group col-md-12 mt-3">
															...
															<div class="o-features">
																<ul class="no-ul-list third-row">
																	...
																	<li>
																		<input id="am-20" class="checkbox-custom amenities" type="checkbox" value="Squash" name="amenities[]">
																		<label for="am-20" class="checkbox-custom-label">Squash</label>
																	</li>
																	<li>
																		<input id="am-21" class="checkbox-custom amenities" type="checkbox" value="Sports Zone" name="amenities[]">
																		<label for="am-21" class="checkbox-custom-label">Sports Zone</label>
																	</li>
																	<li>
																		<input id="am-22" class="checkbox-custom amenities" type="checkbox" value="Yoga Center" name="amenities[]">
																		<label for="am-22" class="checkbox-custom-label">Yoga Center</label>
																	</li>
																	<li>
																		<input id="am-23" class="checkbox-custom amenities" type="checkbox" value="Cycling Track" name="amenities[]">
																		<label for="am-23" class="checkbox-custom-label">Cycling Track</label>
																	</li>
																	<li>
																		<input id="am-24" class="checkbox-custom amenities" type="checkbox" value="Jogging Track" name="amenities[]">
																		<label for="am-24" class="checkbox-custom-label">Jogging Track</label>
																	</li>
																	<li>
																		<input id="am-25" class="checkbox-custom amenities" type="checkbox" value="Food Court" name="amenities[]">
																		<label for="am-25" class="checkbox-custom-label">Food Court</label>
																	</li>
																	<li>
																		<input id="am-26" class="checkbox-custom amenities" type="checkbox" value="Hotel" name="amenities[]">
																		<label for="am-26" class="checkbox-custom-label">Hotel</label>
																	</li>
																	<li>
																		<input id="am-27" class="checkbox-custom amenities" type="checkbox" value="Party Hall" name="amenities[]">
																		<label for="am-27" class="checkbox-custom-label">Party Hall</label>
																	</li>
																	<li>
																		<input id="am-28" class="checkbox-custom amenities" type="checkbox" value="Furnished interior" name="amenities[]">
																		<label for="am-28" class="checkbox-custom-label">Furnished interior</label>
																	</li>
																</ul>
															</div>
													</div>
									...
									<div class="submit-section">
										<div class="form-row">
												<div class="form-group col-md-12">
													...
													<input type="file" name="propBrochure" accept=".pdf" required>
												</div>

                        <div class="form-group col-md-12">
													<label><span style='font-size:15px;color:red'>Price list*</span></label><br>
													<input type="file" name="priceList" accept=".pdf">
												</div>
												<div class="form-group col-md-12">
													<span style='font-size:18px;color:red'>Property RERA approved?</span>
													<input class="ml-1" type="checkbox" name="reraApproved" value="true">
												</div>
												<!-- <input type="submit" value="Save Images" class="btn btn-warning"> -->
...
<script type="text/javascript">
    ...
    $('#save_prop').on("click",function(event){
		...
		$('#config_1,#dimen_1').on("blur",function(){
				var value = $(this).val().trim();
				config_required(1,value);
				dimen_required(1,value);
				image_required(1,value);
			});

		$('#config_2,#dimen_2').on("blur",function(){
			var value = $(this).val().trim();
			config_required(2,value);
			dimen_required(2,value);
			image_required(2,value);
		});

		$('#config_3,#dimen_3').on("blur",function(){
			var value = $(this).val().trim();
			config_required(3,value);
			dimen_required(3,value);
			image_required(3,value);
		});

		$('#config_4,#dimen_4').on("blur",function(){
			var value = $(this).val().trim();
			config_required(4,value);
			dimen_required(4,value);
			image_required(4,value);
		});

		$('#config_5,#dimen_5').on("blur",function(){
			var value = $(this).val().trim();
			config_required(5,value);
			dimen_required(5,value);
			image_required(5,value);
		});

		function config_required(i,value)
		{
			// console.log(value);
			if(value != "")
				{
					$('#config_'+i).attr("required","required");
					console.log($('#config_'+i));
				}
				else{
					$('#config_'+i).removeAttr("required");
					console.log($('#config_'+i));
				}
		}

		function dimen_required(i,value)
		{
			// console.log(value);
			if(value != "")
				{
					$('#dimen_'+i).attr("required","required");
					console.log($('#dimen_'+i));
				}
				else{
					$('#dimen_'+i).removeAttr("required");
					console.log($('#dimen_'+i));
				}
		}
