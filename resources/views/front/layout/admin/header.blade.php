						...
						<div class="nav-menus-wrapper" style="transition-property: none;">
							<ul class="nav-menu">
								...
								<li><a href="JavaScript:Void(0);" style="color: white;">AGENTS<span class="submenu-indicator"></span></a>
									<ul class="nav-dropdown nav-submenu">
										<li><a href="javascript:void(0)">ALL AGENTS</a></li>
								...
								<li>
								<a class="btn btn-danger btn-sm mt-2" href="{{route('bank_prop')}}" style="color: white;padding:1.2rem 0.6rem">BANK MORGAGE PROPERTIES</a>
								</li>
