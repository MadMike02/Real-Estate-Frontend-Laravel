											...
											<div class="form-group">
												<div class="input-with-icon">
													<select class="form-control" name="role">
														...
														<option value="dealer">As a Consultant</option>
													</select>
...
<footer class="dark-footer skin-dark-footer" style="background: linear-gradient(45deg ,#48525c,rgba(47,72,88,0.98));">
				<div>
					<!-- contact form-->
					<div class="container" id="home_contact">
						<div class="row">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-3 col-md-4">
								<div class="footer-widget">
									...
									<div class="footer-add">
										<p>F 59, Nehru Nagar 3, Ghaziabad.</p>
										<p>+91 99588 47190</p>
										<p>ncrhousing.main@gmail.com</p>
									</div>
							...
							<div class="col-lg-3 col-md-4">
								<div class="footer-widget">
									...
									<ul class="footer-menu">
										<li><a href="/#home_about">About Us</a></li>
										<li><a href="/#home_contact">Contact Us</a></li>
										<li><a href="/#feat_prop">Featured Properties</a></li>
										<li><a href="/property/BankMorgage">Bank Morgages Properties</a></li>
							...
							<div class="col-lg-3 col-md-4">
								<div class="footer-widget">
									<h4 class="widget-title">AGENTS</h4>
									<ul class="footer-menu">
										<li><a href="#">ALL AGENTS</a></li>
										<li><a href="#">PLATINUM AGENTS</a></li>
										<li><a href="#">GOLD AGENTS</a></li>
										<li><a href="#">SILVER AGENTS</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="col-lg-3 col-md-6">
								<div class="footer-widget">
									...
									<ul class="footer-menu">
										<li><a href="{{route('admin_dash')}}">My Profile</a></li>
										<li><a href="{{route('admin_add_prop')}}">Add Property</a></li>
										<li><a href="{{route('admin_prop_list')}}">My Property</a></li>
